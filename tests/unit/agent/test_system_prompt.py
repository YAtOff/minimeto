...
def test_render_subagents_filters_promoted():
    ...
    mock_agents = {
        "promoted_agent": {"description": "promoted", "promoted": True},
        "not_promoted_agent": {"description": "not promoted", "promoted": False},
    }
...
def test_render_skills_filters_promoted():
    ...
    mock_skills = {
        "promoted_skill": {"description": "promoted", "promoted": True},
        "not_promoted_skill": {"description": "not promoted", "promoted": False},
    }
